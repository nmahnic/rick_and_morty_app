...
import com.nicomahnic.charactersdetails.di.CharacterDetailsModules
import com.nicomahnic.characterslist.di.CharactersListModules
import com.nicomahnic.characterspaginglist.di.CharactersPagingListModules
    ...
    override fun onCreate() {
        ...
        startKoin {
            ...
            modules(listOf(
                ...
                CharacterDetailsModules.modules,
                CharactersPagingListModules.modules,
